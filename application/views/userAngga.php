          ...
          <div id="table" class="col-md-12">
            <div class="card">
              <div class="card-header">
                <div class="row">
                	<div class="col-6">
                		<h4 class="card-title"> Tabel User Angga</h4>
                	</div>
                	<div class="col-6">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <center>
                            <!-- button hapus -->
                             <?php echo anchor('UserAngga/tampilPengguna/'.$baris->id,'<button class="btn btn-info btn-sm" title="Edit Data"><i class="fa fa-edit"></i></button>'); ?>
                             <!-- button edit -->
                           <?php echo anchor('UserAngga/hapusDataPengguna/'.$baris->id,
