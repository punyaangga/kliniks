...
<head>
  ...
  <title>
    Klinik Nur Khadijah | Biaya Medis
  </title>
...
<body class="">
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="">Biaya Medis</a>
          </div>
          ...
          <div id="table" class="col-md-12">
            <div class="card">
              <div class="card-header">
                <div class="row">
                	<div class="col-6">
                		<h4 class="card-title"> Tabel Biaya Medis</h4>
                	</div>
                	<div class="col-6">
              ...
              <div class="card-body">
                <div class="table-responsive">
                  <table id="tableBiayaMedis" class="table table-striped table-hover">
                	...
                	<div class="row">
                		<div class="col-md-6">
                			<div class="form-group">
                				<label>Nama Biaya Medis</label>
                				<input type="text" name="nama_biaya_medis" class="form-control" placeholder="Nama Biaya Medis" required>
                			</div>
                		</div>
                		<div class="col-md-6">
                			<div class="form-group">
                				<label>Biaya Medis</label>
                				<input type="number" name="biaya_medis" class="form-control" placeholder="Biaya Medis" value="0">
                			</div>
                		</div>
                    <div class="col-md-6">
                      <div class="form-group">
                        <label>Keterangan</label>
                        <input type="text" name="ket_biaya_medis" class="form-control" placeholder="Keterangan">
                      </div>
                    </div>
                	</div>
                </form>
  ...
  <script src="<?php echo base_url('assets/js/admina.biaya.medis.js'); ?>" type="text/javascript"></script>
